git add .# Contributing to PouCode

Thanks for your interest in contributing! FanzzModzz is a fork of
...
- Include: Node.js version, `@FanzzModzz/baileys` version, a minimal reproduction,
...
```bash
git clone https://github.com/FanzzModzz/baileys.git
cd baileys
npm install
npm run build:tsc
npm test
